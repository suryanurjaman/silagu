<div class="container px-6 mx-auto grid">
    ...
    <div class="flex justify-between flex-1">
        <div>
            <a href="?page=master&act=addmapel">
        ...
        <div class="w-full overflow-x-auto">
            <table class="table w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    $data = mysqli_query($con, "SELECT * FROM tb_master_mapel limit $halaman_awal, $batas");
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <a href="?page=master&act=editmapel&id=<?=$k['id_mapel'] ?>">
                ...
                <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                    <nav aria-label="Table navigation">
                        <ul class="inline-flex items-center">
                            <li>
                                <a <?php if ($halaman > 1) {
                                        echo "href='?page=master&act=mapel&halaman=$previous'";
                                    } ?>>
                            ...
                            ?>
                                <li>
                                    <a href="?page=master&act=mapel&halaman=<?php echo $x ?>">
                            ...
                            <li>
                                <a <?php if ($halaman < $total_halaman) {
                                        echo "href='?page=master&act=mapel&halaman=$next'";
                                    } ?>>
