<div class="container px-6 mx-auto grid">
    ...
    <div class="flex justify-between flex-1">
        <p>
            <input class="px-4 justify-start py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" type="button" value="Export Excel" onclick="window.open('laporan-excel.php')">
        </p>
